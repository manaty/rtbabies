	...
	! function(a) {
		...
		a.mobile.Navigator = function(b) {
			...
			popstate : function(b) {
				...
				if (a.event.special.navigate.isPushStateEnabled())
					...
					void 0) : ( c = d.parseLocation().hash, !b.originalEvent.state && c ? ( f = this.squash(c), this.history.add(f.url, f), b.historyState = f,
		...
		a.widget("mobile.pagecontainer", {
			...
			load : function(b, c) {
				...
				return j.reload = j.reloadPage, j.data && "get" === j.type && ( l = a.mobile.path.addSearchParams(l, j.data), j.data = d), j.data && "post" === j.type && (j.reload = !0), e = this._createFileUrl(l), f = this._createDataUrl(l), k = this._find(l), 0 === k.length && a.mobile.path.isEmbeddedPage(e) && !a.mobile.path.isFirstPageUrl(e) ? (i.reject(l, j),
			...
			a.mobile.document.delegate("form", "submit", function(b) {
				...
				if (a.mobile.linkBindingEnabled && !e.isDefaultPrevented()) {
					...
					if (a.mobile.activeClickedLink && a.mobile.activeClickedLink[0] === e.target.parentNode && p(), n && !(e.which > 1) && o.jqmHijackable().length) {
						...
						if ( g = a.mobile.getClosestBaseUrl(o), h = a.mobile.path.makeUrlAbsolute(o.attr("href") || "#", g), !a.mobile.ajaxEnabled && !a.mobile.path.isEmbeddedPage(h))
							return p(),
							void 0;
						if (-1 !== h.search("#")) {
							if ( h = h.replace(/[^#]*#/, ""), !h)
						...
						if ( i = o.is("[rel='external']") || o.is(":jqmData(ajax='false')") || o.is("[target]"), j = i || a.mobile.path.isExternal(h) && !a.mobile.path.isPermittedCrossDomainRequest(f, h))
							return p(),
							void 0;
		...
		a.widget("mobile.slider", a.extend({
			...
			refresh : function(b, d, e) {
				...
				if (z.slider[0].className = [this.isToggleSwitch ? "ui-slider ui-slider-switch ui-slider-track ui-shadow-inset" : "ui-slider-track ui-shadow-inset", E, F, G].join(""), (this.options.disabled || this.element.prop("disabled")) && this.disable(), this.value = this._value(), this.options.highlight && !this.isToggleSwitch && 0 === this.slider.find(".ui-slider-bg").length && (this.valuebg = function() {
					...
					null == b && ( b = m ? parseFloat(l.val() || 0) : l[0].selectedIndex), k = 100 * ((parseFloat(b) - o) / (p - o));
		...
		a.widget("mobile.flipswitch", a.extend({
			...
			_enhance : function() {
				var b = a("<div>"), c = this.options, d = this.element, e = c.theme ? c.theme : "inherit", f = a("<span></span>", {
					tabindex : 1
		...
		a.widget("mobile.controlgroup", a.extend({
			...
			_destroy : function() {
				...
				return c.enhanced ? this : ( a = this._ui, b = this.element.removeClass("ui-controlgroup ui-controlgroup-horizontal ui-controlgroup-vertical ui-corner-all ui-mini " + this._themeClassFromOption(c.theme)).find(".ui-btn").not(".ui-slider-handle"), this._removeFirstLastClasses(b), a.groupLegend.unwrap(), a.childWrapper.children().unwrap(),
				void 0)
			}
		}, a.mobile.behaviors.addFirstLastClasses))
	}(a), function(a, b) {
